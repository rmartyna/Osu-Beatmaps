...
class OptionsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        min_favourited_lineedit = QLineEdit(str(SETTINGS['MIN_FAVOURITED']))
        min_favourited_lineedit.setMaximumWidth(80)
        min_difficulty_label = QLabel("Minimum difficulty of beatmap: ")
        min_difficulty_lineedit = QLineEdit(str(SETTINGS['MIN_DIFFICULTY']))
